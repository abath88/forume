...
<div class="mb-4 bg-white overflow-hidden shadow-sm rounded-lg p-6 text-gray-900 flex p-4 pl-0">
    ...
    <div class="w-11/12">
        <div class="pb-4 border-b">
            <a href="/post/{{ $post->id }}"><h1 class="text-xl font-bold mb-4">{{ $post->title }}</h1></a>
            <div class="text-sm">
        ...
        <div class="mt-4 flex justify-between">
            <div class="flex items-center">
                ...
                >
                <p class="text-sm ml-3">Posted by <a href="#">{{ $post->author->name }}</a> <span class="ml-2">{{ $post->created_at->diffForHumans() }}</span></p>
            </div>
            <div class="flex items-center">
                ...
                <div class="text-sm ml-1">{{ $post->comments->count() }}</div>
            </div>
        </div>
    </div>
</div>
